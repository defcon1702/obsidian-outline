...
describe('buildDocumentTree', () => {
  ...
  it('deeply nested paths (3+ levels)', () => {
    const tree = buildDocumentTree(['a/b/c/deep.md', 'a/b/c/index.md', 'a/b/mid.md']);
  ...
  it('files at root alongside folders', () => {
    const tree = buildDocumentTree(['README.md', 'docs/guide.md', 'CHANGELOG.md']);
  ...
  it('sorts folders before files, then alphabetically', () => {
    const tree = buildDocumentTree(['zebra.md', 'alpha/one.md', 'beta/two.md', 'apple.md']);
