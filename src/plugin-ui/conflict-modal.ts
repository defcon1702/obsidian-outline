...
export function resolveConflict(app: App, title: string): Promise<ConflictResolution> {
...
export function resolveFolderConflictStrategy(app: App): Promise<FolderConflictStrategy> {
  return new Promise((resolve) => {
